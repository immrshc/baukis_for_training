...
ActiveRecord::Schema.define(version: 20160827145347) do
  ...
  create_table "adminstorators", force: true do |t|
    t.string   "email",                           null: false
    t.string   "email_for_index",                 null: false
    t.string   "hashed_password"
    t.boolean  "suspended",       default: false, null: false
  ...
  add_index "adminstorators", ["email_for_index"], name: "index_adminstorators_on_email_for_index", unique: true, using: :btree
